...
class WhatNowEntity extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'legacy_whatnow_entities';
    ...
    {
        return $this->belongsTo('App\Legacy\Models\Region', 'region_id', 'id');
    }
	...
	{
		return $this->hasMany('App\Legacy\Models\WhatNowEntityTranslation', 'entity_id', 'id');
	}
}
