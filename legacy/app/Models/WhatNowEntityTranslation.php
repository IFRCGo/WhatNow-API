...
class WhatNowEntityTranslation extends Model
{
	 ...
	 * @var string
	 */
	protected $table = 'legacy_whatnow_entity_translations';
...
//    }
	...
	{
		return $this->belongsTo('App\Legacy\Models\WhatNowEntity', 'entity_id', 'id');
	}
	...
	{
		return $this->HasMany('App\Legacy\Models\WhatNowEntityStage', 'translation_id', 'id');
	}
